...
htmlhelp_basename = 'NamedTensor-pydoc'
...
texinfo_documents = [
    (master_doc, 'NamedTensor', 'NamedTensor Documentation',
     author, 'NamedTensor', 'One line description of project.',
     'Miscellaneous'),
]
