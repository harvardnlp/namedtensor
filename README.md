...
1) *Naming* Dimension access and reduction use a named `dim(s)` argument instead of an index. Constructing and adding dimensions use a `name(s)` argument. Axis-based indexing \[ \] is replaced by named indexing. 
